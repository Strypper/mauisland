...
class ObservablePropertyControlInfo : ICommunityToolkitGalleryCardInfo
{
    ...
    public string GitHubUrl => $"https://github.com/Strypper/mauisland/tree/main/src/Features/Gallery/Pages/Toolkit/Helpers/{ControlName}";
