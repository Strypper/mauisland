...
public partial class UniformItemsLayoutPageViewModel : NavigationAwareBaseViewModel
{
    #region [ CTor ]
    public UniformItemsLayoutPageViewModel(IAppNavigator appNavigator) : base(appNavigator)
    {
    }
    #endregion
