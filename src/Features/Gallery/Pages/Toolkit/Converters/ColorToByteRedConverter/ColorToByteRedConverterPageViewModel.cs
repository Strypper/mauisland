...
public partial class ColorToByteRedConverterPageViewModel : NavigationAwareBaseViewModel
{
    #region [Services]
    #endregion

    #region [ CTor ]
    public ColorToByteRedConverterPageViewModel(IAppNavigator appNavigator)
        : base(appNavigator)
    { } 
    #endregion
    ...
    string xamlConverterTextTesting =
        ...
        "           <Span Text=\"{x:Binding TextColor1, Converter={x:StaticResource ColorToByteRedConverter}}\"\r\n" +
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "       </FormattedString>\r\n" +
        "   </Label.FormattedText>\r\n" +
        "</Label>\r\n" +
        ...
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "           <Span Text=\" into this Byte Red \"/>\r\n" +
        "           <Span Text=\"{x:Binding TextColor2, Converter={x:StaticResource ColorToByteRedConverter}}\"\r\n" +
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "       </FormattedString>\r\n" +
        "   </Label.FormattedText>\r\n" +
        "</Label>\r\n" +
        ...
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "           <Span Text=\" into this Byte Red \"/>\r\n" +
        "           <Span Text=\"{x:Binding TextColor3, Converter={x:StaticResource ColorToByteRedConverter}}\"\r\n" +
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "       </FormattedString>\r\n" +
        "   </Label.FormattedText>\r\n" +
        "</Label>";
