...
public partial class ColorToCmykStringConverterPageViewModel : NavigationAwareBaseViewModel
{
    #region [Services]
    #endregion

    #region [ CTor ]
    public ColorToCmykStringConverterPageViewModel(IAppNavigator appNavigator)
        : base(appNavigator)
    { } 
    #endregion
    ...
    string xamlConverterTextTesting =
        ...
        "           <Span Text=\"{x:Binding TextColor1, Converter={x:StaticResource ColorToCmykStringConverter}}\"\r\n" +
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "       </FormattedString>\r\n" +
        "   </Label.FormattedText>\r\n" +
        "</Label>\r\n" +
        ...
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "           <Span Text=\" into Cmyk String \"/>\r\n" +
        "           <Span Text=\"{x:Binding TextColor2, Converter={x:StaticResource ColorToCmykStringConverter}}\"\r\n" +
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "       </FormattedString>\r\n" +
        "   </Label.FormattedText>\r\n" +
        "</Label>\r\n" +
        ...
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "           <Span Text=\" into Cmyk String \"/>\r\n" +
        "           <Span Text=\"{x:Binding TextColor3, Converter={x:StaticResource ColorToCmykStringConverter}}\"\r\n" +
        "                 FontAttributes=\"Bold\"/>\r\n" +
        "       </FormattedString>\r\n" +
        "   </Label.FormattedText>\r\n" +
        "</Label>";
